package br.com.wm.designPatterns.padroesDeCriacao.singleton;
...
public class Configuracao {
    ...
    /**
     * Sem synchronized funciona mas se estiver usando um ambiente multi thread
     * pode furar se não tiver synchronized.
     */
